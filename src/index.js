...
module.exports = {
  async onPreBuild({
    inputs: { ejsonPrivateKeyEnvVarName, ejsonSecretsFilePath },
    utils: { build, run },
  }) {
    ...
    try {
      ...
      return build.failBuild(`The ${ejsonSecretsFilePath} file does not exist`)
    }
    ...
    try {
      ...
      return build.failBuild(err.stderr)
    }
